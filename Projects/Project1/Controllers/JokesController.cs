...
namespace Project1.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MyProperty,Description")] Jokes jokes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MyProperty,Description")] Jokes jokes)
        {
            if (id != jokes.Id)
            {
                return NotFound();
